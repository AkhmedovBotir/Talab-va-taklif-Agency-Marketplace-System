...
const AssignedToAgentsOrders = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const response = await adminDataAPI.getOrdersAssignedToAgents(params);
      ...
      const errorMsg = err.message || 'Agentga yuborilgan buyurtmalarni yuklashda xatolik yuz berdi';
      setError(errorMsg);
      showError(errorMsg);
    } finally {
      setLoading(false);
  ...
  return (
    <div>
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Agentga Yuborilgan Buyurtmalar</h1>
...
export default AssignedToAgentsOrders;
