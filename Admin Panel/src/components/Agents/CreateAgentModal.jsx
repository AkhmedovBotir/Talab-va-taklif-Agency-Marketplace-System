...
const CreateAgentModal = ({ open, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare data - tuman and mfy can be empty strings (will be sent as null)
      const agentData = {
        name: formData.name,
      ...
      if (response.success) {
        showSuccess(response.message || 'Agent muvaffaqiyatli yaratildi');
        setFormData({
          name: '',
          viloyat: '',
          tuman: '',
      ...
      const errorMsg = err.message || 'Agent yaratishda xatolik yuz berdi';
      setError(errorMsg);
      showError(errorMsg);
    } finally {
      setLoading(false);
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h2 className="text-2xl font-bold text-gray-800">Yangi Agent Yaratish</h2>
                <button
                  onClick={handleClose}
