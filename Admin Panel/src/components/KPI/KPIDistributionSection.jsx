...
import KPIDistributionList from '../Settings/KPI/KPIDistributionList';
import KPIDistributionModal from '../Settings/KPI/KPIDistributionModal';

const KPIDistributionSection = () => {
...
export default KPIDistributionSection;
