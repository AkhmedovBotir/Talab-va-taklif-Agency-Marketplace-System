...
const KPIAgentsSection = () => {
  ...
  const fetchAgents = async ({ page, limit } = {}) => {
    ...
    try {
      ...
      showError(error.message || 'Agentlarni yuklashda xatolik');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-500">Agentlar topilmadi</div>
      ) : (
        <>
...
export default KPIAgentsSection;
