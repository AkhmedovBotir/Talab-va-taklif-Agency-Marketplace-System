    ...
    <>
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            className="relative flex w-full flex-col overflow-y-auto bg-white shadow-2xl max-md:h-full max-md:min-h-[100dvh] max-md:rounded-none max-md:shadow-none md:mb-0 md:h-auto md:max-h-[90vh] md:max-w-5xl lg:flex-row lg:overflow-hidden lg:rounded-[48px] lg:safe-area-inset-bottom"
          ...
          >
            ...
            <div className="flex flex-col overflow-y-auto bg-white p-8 pb-32 lg:w-1/2 lg:p-12 lg:pb-12">
              ...
              <div className="flex flex-col gap-6 border-t border-gray-100 pt-8">
                ...
                {outOfStock ? (
                  <div className="flex w-full items-center justify-center rounded-2xl border border-gray-200 bg-gray-100 py-5 text-sm font-black uppercase tracking-wider text-gray-400">
                    Omborda yo&apos;q
                  </div>
                ) : inCartQty <= 0 ? (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-2xl border-2 border-transparent bg-gray-900 py-5 font-bold text-white shadow-2xl shadow-gray-200 transition-all hover:border-white/20 hover:bg-orange-500 active:scale-[0.98]"
                  >
      ...
      <AnimatePresence>
        {isLightboxOpen && (
          ...
          >
            <button type="button" className="absolute right-6 top-6 rounded-full p-2 text-white transition-colors hover:bg-white/10">
              <X size={32} />
            </button>
            <motion.img
