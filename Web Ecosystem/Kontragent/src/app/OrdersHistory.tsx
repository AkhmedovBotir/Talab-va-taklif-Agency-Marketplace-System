...
import { IoReceiptOutline, IoStorefront, IoTime, IoCash, IoChevronForward } from 'react-icons/io5';
...
export function OrdersHistory() {
  ...
  const loadOrders = useCallback(async (pageNum = 1, status?: OrderStatus) => {
    try {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <Link to="/buyurtmalar" className={styles.historyButton}>
          Bugungi
        </Link>
      </div>
