...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    ...
    if (!formData.name.trim() || !formData.phone.trim()) {
      Alert.alert('Xatolik', 'Ism va telefon raqami majburiy');
      return;
    }
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          ...
          <Text style={styles.sectionTitle}>Kontragent ma'lumotlari</Text>
        </View>
        <View style={styles.infoRow}>
          <Text style={styles.label}>Kontragent nomi:</Text>
          <Text style={styles.value}>{deliveryProvider.contragent.name}</Text>
        </View>
        <View style={styles.infoRow}>
