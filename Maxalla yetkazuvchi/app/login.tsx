...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    if (!phone.trim() || !password.trim()) {
      showSnackbar('Iltimos, barcha maydonlarni to\'ldiring', 'error');
      return;
    }
    ...
    try {
      ...
      showSnackbar('Tizimga muvaffaqiyatli kirildi', 'success');
      router.replace('/(tabs)');
    } catch (error: any) {
      showSnackbar(error.message || 'Telefon raqami yoki parol noto\'g\'ri', 'error');
    } finally {
      setLoading(false);
    }
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity
              ...
              disabled={loading}
            >
              <Text style={styles.linkText}>Parol o&apos;rnatish / tiklash</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
