...
const CreateDistrictContragentModal = ({ open, onClose, onSuccess, regions, districts, mfys }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await contragentAPI.create(payload);
      if (res.success) {
        showSuccess(res.message || 'Kontragent yaratildi');
        setForm(emptyForm());
        onSuccess?.();
      }
    } catch (err) {
          ...
          >
            ...
            >
              <div className="flex items-center justify-between p-6 border-b">
                <h2 className="text-xl font-bold text-gray-800">Yangi kontragent</h2>
...
export default CreateDistrictContragentModal;
