        ...
        <nav className="flex-1 overflow-y-auto py-4 custom-scrollbar">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.13 }}>
            <div className="mx-2 mb-1">
              <motion.div whileHover={{ backgroundColor: 'rgba(129, 140, 248, 0.2)', x: isOpen ? 5 : 0 }} className="rounded-lg">
                <div
                  onClick={() => navigate('/dashboard/commentary')}
                  className={`flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} p-3 cursor-pointer rounded-lg transition-colors ${
                    isPathActive('/dashboard/commentary') ? 'bg-indigo-800' : 'hover:bg-indigo-800/70'
                  }`}
                >
          ...
          {admin?.role === 'general' && (
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }}>
              <div className="mx-2 mb-1">
                <motion.div whileHover={{ backgroundColor: 'rgba(129, 140, 248, 0.2)', x: isOpen ? 5 : 0 }} className="rounded-lg">
                  <div
                    onClick={() => navigate('/dashboard/integration-api-keys')}
                    className={`flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} p-3 cursor-pointer rounded-lg transition-colors ${
                      isPathActive('/dashboard/integration-api-keys') ? 'bg-indigo-800' : 'hover:bg-indigo-800/70'
                    }`}
                  >
              ...
              <div className="mx-2 mb-1">
                <motion.div whileHover={{ backgroundColor: 'rgba(129, 140, 248, 0.2)', x: isOpen ? 5 : 0 }} className="rounded-lg">
                  <div
                    ...
                    className={`flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} p-3 cursor-pointer rounded-lg transition-colors ${
                      isPathActive('/dashboard/archive') ? 'bg-indigo-800' : 'hover:bg-indigo-800/70'
                    }`}
                  >
          ...
          {admin?.role === 'general' && (
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.17 }}>
              <div className="mx-2 mb-1">
                <motion.div whileHover={{ backgroundColor: 'rgba(129, 140, 248, 0.2)', x: isOpen ? 5 : 0 }} className="rounded-lg">
                  <div
                    onClick={() => navigate('/dashboard/qr-system')}
                    className={`flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} p-3 cursor-pointer rounded-lg transition-colors ${
                      isPathActive('/dashboard/qr-system') ? 'bg-indigo-800' : 'hover:bg-indigo-800/70'
                    }`}
                  >
