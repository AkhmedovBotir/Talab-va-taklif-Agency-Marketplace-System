...
const ManagerTable = ({ rows, loading, onEdit, onDelete, onView, pagination, onPageChange, onRefresh, regions = [] }) => {
        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Parol o'rnatish</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Parol mavjud</th>
            ...
            {rows.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm text-gray-700">{row.password_setup_allowed === false ? "Yo'q" : 'Ha'}</td>
                  <td className="px-4 py-3 text-sm text-gray-700">{row.has_password ? 'Ha' : "Yo'q"}</td>
