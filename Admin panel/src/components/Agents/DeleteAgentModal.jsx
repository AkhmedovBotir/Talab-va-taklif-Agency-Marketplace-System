...
const DeleteAgentModal = ({ open, onClose, onSuccess, row }) => {
          ...
          >
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center justify-between p-6 border-b">
                <h2 className="text-lg font-bold text-gray-800">Agentni o‘chirish</h2>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4 mb-6">
                  ...
                  <div>
                    <p className="text-gray-700 mb-2">Bu agentni o‘chirishni tasdiqlaysizmi?</p>
