...
const EditAgentModal = ({ open, onClose, onSuccess, agentId, regions, districts, mfys }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await agentAPI.update(agentId, payload);
      if (res.success) {
          ...
          >
            ...
            >
              <div className="flex items-center justify-between p-6 border-b">
                <h2 className="text-xl font-bold text-gray-800">Agentni tahrirlash</h2>
