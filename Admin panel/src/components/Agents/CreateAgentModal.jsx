...
const CreateAgentModal = ({ open, onClose, onSuccess, regions, districts, mfys }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        showSuccess(res.message || 'Agent yaratildi');
        setForm(emptyForm());
        onSuccess?.();
      }
    } catch (err) {
          ...
          >
            ...
            >
              <div className="flex items-center justify-between p-6 border-b">
                <h2 className="text-xl font-bold text-gray-800">Yangi agent</h2>
