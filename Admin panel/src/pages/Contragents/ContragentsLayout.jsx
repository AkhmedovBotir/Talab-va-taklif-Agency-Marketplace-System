...
const ContragentsLayout = () => {
  ...
  const isPartnerRequestsPage = location.pathname.includes('/contragents/hamkorlik-sorovlari');
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <NavLink
            to="/dashboard/contragents/hamkorlik-sorovlari"
            className={({ isActive }) =>
              `${tabBase} ${isActive ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'}`
            }
          >
          ...
          {(isTypesPage || isDistrictPage || isShopsPage) && !isPartnerRequestsPage && (
