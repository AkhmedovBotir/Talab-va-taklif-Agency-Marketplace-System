...
const CreatePunktModal = ({ open, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.tuman) {
        punktData.tuman = formData.tuman;
      }

      const response = await punktAPI.createPunkt(punktData);
      if (response.success) {
        showSuccess(response.message || 'Punkt muvaffaqiyatli yaratildi');
        setFormData({
          name: '',
          viloyat: '',
          tuman: '',
      ...
      const errorMsg = err.message || 'Punkt yaratishda xatolik yuz berdi';
      setError(errorMsg);
      showError(errorMsg);
    } finally {
      setLoading(false);
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h2 className="text-2xl font-bold text-gray-800">Yangi Punkt Yaratish</h2>
                <button
                  onClick={handleClose}
