...
const TABS = [
  {
    ...
    label: 'Statistika',
    icon: BarChart,
    component: KPIStatisticsSection,
  },
  {
    id: 'transactions',
...
const KPIMain = () => {
  ...
  const defaultTab = allowedTabs[0]?.id || 'statistics';
    ...
    <div>
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-gray-800">KPI Boshqaruvi</h1>
        </div>
        <p className="text-gray-600">KPI bonus ma'lumotlari va statistikasi</p>
      </motion.div>
