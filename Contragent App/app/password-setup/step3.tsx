...
export default function PasswordSetupStep3Screen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Muvaffaqiyatli', 'Parol muvaffaqiyatli o\'rnatildi', [
        {
          text: 'OK',
          onPress: async () => {
            ...
            try {
              ...
              // Login xatosi bo'lsa, login sahifasiga yuborish
              Alert.alert('Parol o\'rnatildi', 'Endi login sahifasida kirishingiz mumkin', [
                {
                  text: 'OK',
