...
import DeleteDistrictContragentModal from '../../components/DistrictContragents/DeleteDistrictContragentModal';
import ViewDistrictContragentModal from '../../components/DistrictContragents/ViewDistrictContragentModal';
import GeoCascadeSearchableFields from '../../components/DistrictContragents/GeoCascadeSearchableFields';

const DistrictContragents = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <EditDistrictContragentModal
        open={editOpen}
        contragentId={selectedId}
        onClose={() => {
          setEditOpen(false);
          setSelectedId(null);
        }}
...
export default DistrictContragents;
