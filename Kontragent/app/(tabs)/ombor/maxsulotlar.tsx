...
export default function MaxsulotlarScreen() {
  ...
  const gutter = isWeb ? pageGutter : 16;
  ...
  return (
    <View style={styles.container}>
      <View
        style={[
          styles.pageInner,
          { maxWidth: maxPageWidth, paddingBottom: Platform.OS === 'web' ? 16 : 0 },
        ]}
      >
      {/* Search Bar */}
      <View style={[styles.searchContainer, { marginHorizontal: gutter, marginTop: gutter, marginBottom: 8 }]}>
      ...
      {/* Create Button */}
      <TouchableOpacity
        style={[styles.fab, { right: Math.max(gutter, 20), bottom: Math.max(gutter, 20) }]}
        onPress={() => {
          router.push('/ombor/product/create' as any);
        }}
      >
      ...
      >
        <View style={[styles.filterModalOverlay, isDesktopWeb && styles.filterModalOverlayDesktop]}>
          <View style={[styles.filterModalContent, isDesktopWeb && styles.filterModalContentDesktop]}>
