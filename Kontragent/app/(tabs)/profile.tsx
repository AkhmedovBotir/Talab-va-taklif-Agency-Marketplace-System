...
export default function ProfileScreen() {
  ...
  const { dialog, confirm: showConfirm } = useAppDialog();
  ...
  const handleSelectDeliveryRegions = () => {
    router.push({
      pathname: '/ombor/product/select-regions' as any,
      params: {
        returnPath: '/profile',
  ...
  const handleLogout = () => {
    showConfirm(
      ...
      { confirmLabel: 'Chiqish', destructive: true }
    );
  };
  ...
  const actionsSection = (
    <View style={styles.actionsCard}>
      ...
      <TouchableOpacity style={styles.actionButton} onPress={() => router.push('/habarlar')}>
